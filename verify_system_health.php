...
try {
    ...
    $methodStats = new ReflectionMethod(FinancialStatsOverview::class, 'getStats');
...
$originalCount = SystemActivity::count();
...
$resourceQuery = SystemActivityResource::getEloquentQuery()->toSql();
