    ...
    <div class="overflow-x-auto">
        <table class="min-w-full">
            <thead class="bg-[#faf9f6]/80">
                <tr>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-sand-500 uppercase tracking-wider">Fecha</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-sand-500 uppercase tracking-wider">Monto</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-sand-500 uppercase tracking-wider">Método</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-sand-500 uppercase tracking-wider">Estado</th>
                    <th class="px-6 py-4 text-left text-xs font-semibold text-sand-500 uppercase tracking-wider">Referencia</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-stone-100">
                ...
                @empty
                <tr>
                    <td colspan="5" class="px-6 py-12 text-center text-sand-500">
