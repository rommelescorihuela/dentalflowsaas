...
<div class="flex justify-between items-center mb-6 portal-reveal">
    ...
    <a href="{{ URL::signedRoute('portal.book', ['patient' => $patient]) }}"
        class="inline-flex items-center px-5 py-2.5 border border-transparent rounded-xl shadow-lg text-sm font-medium text-white bg-primary-600 hover:bg-primary-700 transition-all duration-200">
...
<div class="bg-white overflow-hidden shadow-xl shadow-gray-200/50 sm:rounded-2xl border border-gray-100 mb-8 portal-reveal portal-reveal-delay-1">
...
<!-- Past Appointments -->
<div class="bg-white overflow-hidden shadow-xl shadow-gray-200/50 sm:rounded-2xl border border-gray-100 portal-reveal portal-reveal-delay-2">
    ...
    <div class="p-6 space-y-3">
        ...
        <div class="bg-[#faf9f6] border border-stone-100 rounded-2xl p-5">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-sand-500">{{ $appointment->start_time->format('d/m/Y H:i') }}</p>
                    </div>
                </div>
                <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium
                    ...
                    @elseif($appointment->status === 'confirmed') bg-emerald-100 text-emerald-700
                    @elseif($appointment->status === 'scheduled') bg-primary-100 text-primary-700
