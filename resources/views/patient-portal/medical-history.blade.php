...
<div class="space-y-6">
    <!-- Antecedentes -->
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden portal-reveal portal-reveal-delay-1">
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="col-span-full">
                ...
                <p class="text-stone-700 bg-[#faf9f6] rounded-xl p-4 border border-stone-100">{{ $medicalHistory->antecedentes_personales }}</p>
            </div>
            @endif
            ...
            <div class="col-span-full">
                ...
                <p class="text-stone-700 bg-[#faf9f6] rounded-xl p-4 border border-stone-100">{{ $medicalHistory->antecedentes_familiares }}</p>
            </div>
            @endif
            ...
            <div class="col-span-full">
                ...
                <p class="text-stone-700 bg-[#faf9f6] rounded-xl p-4 border border-stone-100">{{ $medicalHistory->enfermedades_cronicas }}</p>
            </div>
            @endif
        </div>
    </div>
    ...
    <!-- Hábitos y Cirugías -->
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden portal-reveal portal-reveal-delay-2">
        <div class="px-6 py-5 border-b border-gray-100 bg-primary-50">
            <h3 class="text-lg font-bold text-gray-900 flex items-center">
                <span class="bg-primary-600 text-white p-2 rounded-lg mr-3 shadow-lg shadow-primary-500/20">
        ...
        <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <p class="text-stone-700 bg-[#faf9f6] rounded-xl p-4 border border-stone-100">{{ $medicalHistory->habitos }}</p>
            </div>
            @endif
            ...
            <div>
                ...
                <p class="text-stone-700 bg-[#faf9f6] rounded-xl p-4 border border-stone-100">{{ $medicalHistory->cirugias_previas }}</p>
            </div>
            @endif
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden portal-reveal portal-reveal-delay-3">
        ...
        <div class="p-6">
            <p class="text-stone-700 bg-[#faf9f6] rounded-xl p-4 border border-stone-100">{{ $medicalHistory->historia_dental }}</p>
        </div>
    </div>
    @endif
    ...
    <div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden portal-reveal portal-reveal-delay-4">
        <div class="px-6 py-5 border-b border-gray-100 bg-primary-50">
            <h3 class="text-lg font-bold text-gray-900 flex items-center">
                <span class="bg-primary-600 text-white p-2 rounded-lg mr-3 shadow-lg shadow-primary-500/20">
        ...
        <div class="p-6 grid grid-cols-2 md:grid-cols-5 gap-6">
            ...
            <div class="text-center p-4 bg-stone-50 rounded-xl">
                ...
                <p class="text-xs text-sand-500">mmHg</p>
            </div>
            @endif
            ...
            <div class="text-center p-4 bg-stone-50 rounded-xl">
                ...
                <p class="text-xs text-sand-500">lpm</p>
            </div>
            @endif
            ...
            <div class="text-center p-4 bg-stone-50 rounded-xl">
                ...
                <p class="text-xs text-sand-500">kg</p>
            </div>
            @endif
            ...
            <div class="text-center p-4 bg-stone-50 rounded-xl">
                ...
                <p class="text-xs text-sand-500">m</p>
            </div>
            @endif
...
<div class="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100 p-12 text-center">
    ...
    <p class="text-sm text-sand-500 mt-1">Tu doctor registrará tu historia clínica durante tu primera consulta.</p>
</div>
@endif
@endsection
