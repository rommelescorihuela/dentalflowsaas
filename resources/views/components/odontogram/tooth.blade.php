<div class="flex flex-col items-center gap-1"
    ...
    <!-- SVG Container -->
    <div class="relative group cursor-pointer" style="position: relative; cursor: pointer;">
        <svg width="40" height="{{ $isUpper ? '60' : '60' }}" viewBox="0 0 40 60"
            style="transform: {{ $isUpper ? 'scaleY(1)' : 'scaleY(-1)' }}; display: block;">

            <!-- Root (Background) -->
            <path d="M12 20 L15 55 L20 45 L25 55 L28 20 Z" fill="{{ $rootStatus ? $colors[$rootStatus] : '#e5e7eb' }}"
            ...
            <g transform="translate(0, 0)">
                ...
                <path d="M6 10 L14 14 L26 14 L34 10 Q20 -2 6 10 Z"
                    fill="{{ $surfaces['top'] ? $colors[$surfaces['top']] : 'white' }}"
                ...
                <path d="M6 30 L14 26 L26 26 L34 30 Q20 42 6 30 Z"
                    fill="{{ $surfaces['bottom'] ? $colors[$surfaces['bottom']] : 'white' }}"
                ...
                <path d="M6 10 L14 14 L14 26 L6 30 Q-2 20 6 10 Z"
                    fill="{{ $surfaces['left'] ? $colors[$surfaces['left']] : 'white' }}"
                ...
                <path d="M34 10 L26 14 L26 26 L34 30 Q42 20 34 10 Z"
                    fill="{{ $surfaces['right'] ? $colors[$surfaces['right']] : 'white' }}"
                ...
                <rect x="14" y="14" width="12" height="12"
                    fill="{{ $surfaces['center'] ? $colors[$surfaces['center']] : 'white' }}"
