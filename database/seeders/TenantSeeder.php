...
class TenantSeeder extends Seeder
{
    public function run(): void
    {
        ...
        \App\Models\Patient::factory()->count(15)->create(['clinic_id' => $clinic1->id]);
        \App\Models\Inventory::factory()->count(20)->create(['clinic_id' => $clinic1->id]);
        \App\Models\ProcedurePrice::factory()->count(10)->create(['clinic_id' => $clinic1->id]);
        ...
        \App\Models\Patient::factory()->count(10)->create(['clinic_id' => $clinic2->id]);
        \App\Models\Inventory::factory()->count(15)->create(['clinic_id' => $clinic2->id]);
        \App\Models\ProcedurePrice::factory()->count(8)->create(['clinic_id' => $clinic2->id]);
    }
}
