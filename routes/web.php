...
Route::middleware([
    ...
    Route::get('/{tenant?}/portal/{patient}/budgets/{budget}', [\App\Http\Controllers\PatientPortalController::class, 'viewBudget'])->name('portal.budgets.view');
    Route::get('/{tenant?}/portal/{patient}/budgets/{budget}/pdf', [\App\Http\Controllers\PdfController::class, 'downloadBudgetPortal'])->name('portal.budgets.pdf');
    Route::post('/{tenant?}/portal/{patient}/budgets/{budget}/accept', [\App\Http\Controllers\PatientPortalController::class, 'acceptBudget'])->name('portal.budgets.accept');
    Route::post('/{tenant?}/portal/{patient}/budgets/{budget}/reject', [\App\Http\Controllers\PatientPortalController::class, 'rejectBudget'])->name('portal.budgets.reject');
});
